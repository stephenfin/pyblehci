...
class BLEParser(threading.Thread):
    """
    A parser for event packets as defined by the the Texas Instruments
    Bluetooth Low Energy Host-Controller-Interface (HCI).

    Capable of monitoring a serial device, parsing the packets and
    returning to a calling method by callback.
    """
    # dictionaries
